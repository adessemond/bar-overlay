...
if [[ ${PV} = *9999* ]]; then
	...
	SRC_URI="http://download.savannah.gnu.org/releases/qemu/${P}.tar.bz2 http://wiki.qemu.org/download/${P}.tar.bz2"
...
IUSE="+aio alsa bluetooth brltty curl esd fdt jpeg ncurses \
...
src_configure() {
	...
	# "--disable-darwin-user" is no more present in 1.1
	conf_opts="${conf_opts} --disable-bsd-user"
